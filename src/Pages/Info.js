      ...
      <div className="mx-auto">
        ...
        <div className="flex flex-col md:flex-row px-4 md:px-20 gap-4 md:gap-8 vision-container">
          <div className="pt-4 md:w-2/3">
            ...
            <span className="block w-[300px] h-px bg-gray-700"></span>
        ...
        <p className="px-15 py-4 text-xl md:px-15">
          ...
          engaging, interactive, and effective learning experiences. Our courses
        ...
        <div className="flex">
          <div className="flex flex-col justify-end py-2 ml-auto mr-8 font-bold">
            <a href="/info">More About Us</a>
            <span className="block w-[120px] h-px mt-2 bg-gray-700"></span>
          </div>
        </div>
      </div>
    </section>
