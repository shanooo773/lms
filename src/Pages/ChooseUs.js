    ...
    <section id='chooseus' className="bg-white ">
      ...
      <div className="flex flex-wrap justify-center gap-6 px-2 md:gap-10 md:px-8 lg:gap-12 mb-8">
        {features.slice(0, 3).map((feature, index) => (
          <div key={index} className="flex flex-col w-[350px] h-[220px] bg-[#EEEEEE] rounded-lg rounded-t-2xl shadow-md transition-transform transform hover:scale-105">
            <div className="flex items-center p-4 mb-4 rounded-t-2xl" style={{
              ...
              <span className="mr-2 text-2xl material-icons">
                <img src={courseIcons[index]} alt="Logo" className="w-10 h-10" />
              </span>
      ...
      <div className="flex flex-wrap justify-center gap-6 px-2 md:gap-10 md:px-8 lg:gap-12">
        {features.slice(3, 6).map((feature, index) => (
          <div key={index + 3} className="flex flex-col w-[350px] h-[220px] bg-[#EEEEEE] rounded-lg rounded-t-2xl shadow-md transition-transform transform hover:scale-105">
            <div className="flex items-center p-4 mb-4 rounded-t-2xl" style={{
              background: "linear-gradient(to bottom, rgba(94, 213, 245, 0.8), rgba(55, 131, 246, 0.8))"
            }}>
              <span className="mr-2 text-2xl material-icons">
                <img src={courseIcons[index + 3]} alt="Logo" className="w-10 h-10" />
              </span>
              <h3 className="text-xl font-semibold">{feature}</h3>
            </div>
            <p className="p-4 text-black">{descriptions[index + 3]}</p>
          </div>
        ))}
      </div>
    </section>
